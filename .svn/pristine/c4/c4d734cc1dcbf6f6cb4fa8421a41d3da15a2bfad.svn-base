 ...
 * @param {*参数} param
 */
export function mealDetail(param, closeLoading) {
  return request.fetchPost('/v1/app/setMeal/select', param, closeLoading)
}
/**
 * 查看所有套餐
 * @param {*参数} param
 */
export function mealList(param, closeLoading) {
  return request.fetchPost('/v1/app/setMeal/selectList', param, closeLoading)
}
