 ...
 * @param {*参数} param
 */
export function payOk(param, closeLoading) {
  return request.fetchPost('/v1/pay/queryOrder', param, closeLoading)
}
/**
 * 查看订单列表
 * @param {*参数} param
 ...
 * @param {*参数} param
 */
export function feedback(param, closeLoading) {
  return request.fetchPost('/v1/app/feedback/insert', param, closeLoading)
}
/**
 * 上传文件
 * @param {*参数} param
 */
export function upLoad(param, closeLoading) {
  return request.fetchPost('/v1/app/upload', param, closeLoading)
}
