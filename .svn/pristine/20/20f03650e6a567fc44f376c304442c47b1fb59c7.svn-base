    ...
    <van-cell-group  style="position:fixed;top:45px;width:100%;" >
      <van-cell >
        <van-row>
          ...
          <van-col span="12" style="text-align:center;border-left:1px solid #e5e5e5;" @click.native="$router.push({path:'/user/integral/integralLog'})" ><van-icon name="records"  style="margin-top:5px;"/>&nbsp;兑换记录</van-col>
        </van-row>
      </van-cell>
    </van-cell-group>
