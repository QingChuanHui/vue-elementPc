  ...
  <div>
    ...
    <div class="mTop">
      ...
      <div class="flexbox" >
        ...
        <div class="flexTop1" style='text-align:center'>
          <van-icon name="photograph" @click.native="getPic()" style='margin-top:1rem;font-size:2rem'/>
